...
if (!class_exists('admin_folder_Redux_Framework_config')) {
	...
	* */
		...
		* */
			...
			'type'      => 'switch',
			'title'     => 'Replace URIs',
			'subtitle'  => "If checked, the hostname ($home_url) in links will be replaced with <em>URL prefix</em>.",
			'default'   => 1,
			'on'        => 'Enabled',
			'off'       => 'Disabled',
			),
			...
			array(
		    'id'=>'multi_local_host_aliases',
		    'type' => 'multi_text',
		    'show_empty' => false,
		//'required'  => array('replace_uri_in_links', '=', '1'),
		    'title' => 'Local hostname aliases',
		    'subtitle' => '',
		    'validate' => 'url',
		    'desc' => "These URLs will be considered equivalent to <em>$home_url</em>",
		    'default' => null
		    ),	
			array(
			...
			array(
			'id'        => 'skip_index_files_in_uploads_folder',
			'type'      => 'switch',
			'title'     => 'Index upload folders',
			'desc'     => 'When turned on, the uploads directory (and all subdirectories) will be indexed',
			'subtitle'  => "",
			'default'   => 0,
			'on'        => 'Enabled',
			'off'       => 'Disabled',
